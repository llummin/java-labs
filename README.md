...
13. Ваше фактическое задание выполнять применительно к БД: 0 — «Учебные
    аудитории», `1 — «Домашняя библиотека»`.
14. Выбор записи для удаления или изменения по: `0 — номеру в общем списке`, 1 — по
    уникальному ключу (можно посмотреть в IDE NetBeans).
15. В приложении реализовать просмотр записей, хранящихся в БД, добавление записей
    в БД, изменение записей, хранящихся в БД, и удаление записей из БД.
16. При реализации приложение придерживаться простоты и наглядности,
