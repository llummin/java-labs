...
public class Data {
  ...
  public Data(int[][] intData, double[][] doubleData, String[][] stringData) {
    ...
    this.protectedAreas = new ProtectedAreas(10, 10);
  }

  public void setProtectedAreasFromCommandLine(String[] args) {
    int arrayNumber = Integer.parseInt(args[0]);
    ...
    protectedAreas.setCellProtected(arrayNumber, startRow, startCol, endRow, endCol, true);
  }
  ...
  public int getIntCell(int rowIndex, int columnIndex) {
    if (isCellProtected(0, rowIndex, columnIndex)) {
